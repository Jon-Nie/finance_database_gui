...
class MainWindow(QMainWindow):
    ...
    def set_connections(self, model):
        ...
        self.model.update_country_icon.connect(self.content.pages.stock_page.description_box.address.country_logo.update_icon)
        self.mapper.addMapping(self.content.pages.stock_page.description_box.address.country_name, 9, b"text")
        ...
        self.model.update_value_box.connect(self.content.pages.stock_page.value_box.set_data)
        self.model.update_profitability_box.connect(self.content.pages.stock_page.profitability_box.set_data)
        self.model.update_growth_box.connect(self.content.pages.stock_page.growth_box.set_data)
        self.model.update_fundamental_view.connect(self.content.pages.stock_page.fundamental_view.set_data)
        self.model.update_prices.connect(self.content.pages.stock_page.prices_box.price_view.set_data)
        self.mapper.toFirst()
